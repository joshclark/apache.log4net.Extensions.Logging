...
namespace Microsoft.Extensions.Logging
{
    ...
    public static class LoggingExtensions
    {
        ...
        public static ILoggingBuilder AddLog4Net(this ILoggingBuilder self)
        {
        ...
        /// <returns>The passed in logging builder</returns>
        public static ILoggingBuilder AddLog4Net(this ILoggingBuilder self, IConfiguration configuration)
        {
